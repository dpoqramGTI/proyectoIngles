<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="WebApplication.doctor.WebForm3" %>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <form id="addPatient" runat="server">
                ...
                <asp:TextBox ID="dniTextbox" runat="server" />
