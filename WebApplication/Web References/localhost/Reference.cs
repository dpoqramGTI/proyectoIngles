...
namespace WebApplication.localhost {
    using System;
    ...
    public partial class WebService1 : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public WebService1() {
            this.Url = global::WebApplication.Properties.Settings.Default.WebApplication_localhost_WebService1;
        ...
        /// <remarks/>
        public void insertHistoricAsync(int doctorId, int pacientId, string diagnose, string treatment) {
            this.insertHistoricAsync(doctorId, pacientId, diagnose, treatment, null);
        }
        
        /// <remarks/>
        public void insertHistoricAsync(int doctorId, int pacientId, string diagnose, string treatment, object userState) {
            ...
            this.InvokeAsync("insertHistoric", new object[] {
                        ...
                        pacientId,
                        diagnose,
                        treatment}, this.insertHistoricOperationCompleted, userState);
        }
        ...
        public Historic[] getAllDoctorPacients(int doctorId, int pacientId) {
        ...
        /// <remarks/>
        public void getAllDoctorPacientsAsync(int doctorId, int pacientId) {
            this.getAllDoctorPacientsAsync(doctorId, pacientId, null);
        }
        
        /// <remarks/>
        public void getAllDoctorPacientsAsync(int doctorId, int pacientId, object userState) {
            ...
            this.InvokeAsync("getAllDoctorPacients", new object[] {
                        doctorId,
                        pacientId}, this.getAllDoctorPacientsOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void updatePacientAsync(string pacientId, string dni, string name, string password) {
            this.updatePacientAsync(pacientId, dni, name, password, null);
        }
        
        /// <remarks/>
        public void updatePacientAsync(string pacientId, string dni, string name, string password, object userState) {
            ...
            this.InvokeAsync("updatePacient", new object[] {
                        ...
                        dni,
                        name,
                        password}, this.updatePacientOperationCompleted, userState);
        }
